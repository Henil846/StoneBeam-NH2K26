...
```ts
import { useCreateDemoUser, useListAllServices, useGetProjectDetails, useUpdateProjectStatus } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateDemoUser();

const { data, isPending, isSuccess, isError, error } = useListAllServices();
...
```js
import { createDemoUser, listAllServices, getProjectDetails, updateProjectStatus } from '@dataconnect/generated';
